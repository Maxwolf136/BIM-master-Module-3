...
// node_modules/bim-fragment/geometry-utils.js
...
// node_modules/bim-fragment/fragment-mesh.js
var FragmentMesh = class _FragmentMesh extends InstancedMesh {
  constructor(geometry, material, count, fragment) {
    ...
    this.material = _FragmentMesh.newMaterialArray(material);
  ...
  newFragmentGeometry(geometry) {
    ...
    if (!geometry.attributes.blockID) {
      ...
      geometry.attributes.blockID = new BufferAttribute2(array, 1);
    }
    const size = geometry.index.count;
    _FragmentMesh.initializeGroups(geometry, size);
    return geometry;
  }
...
// node_modules/bim-fragment/blocks.js
var Blocks = class {
  constructor(fragment) {
    this.fragment = fragment;
    this._visibilityInitialized = false;
    this._originalIndex = /* @__PURE__ */ new Map();
...
// node_modules/bim-fragment/bvh.js
var BVH = class _BVH {
...
// node_modules/bim-fragment/fragment.js
var Fragment = class _Fragment {
  ...
  addFragment(id, material = this.mesh.material) {
    ...
    const newFragment = new _Fragment(newGeometry, material, this.capacity);
  ...
  deleteAndRearrange(id) {
    ...
    this.items.pop();
    this.mesh.getMatrixAt(lastElement, tempMatrix2);
...
// node_modules/bim-fragment/flatbuffers/fragments/index/fragment.js
var Fragment2 = class _Fragment {
  ...
  static getRootAsFragment(bb, obj) {
    return (obj || new _Fragment()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
  }
  ...
  static createFragment(builder, positionOffset, normalOffset, indexOffset, blockIdOffset, groupsOffset, materialsOffset, matricesOffset, colorsOffset, idsOffset, idOffset, compositesOffset) {
    _Fragment.startFragment(builder);
    _Fragment.addPosition(builder, positionOffset);
    _Fragment.addNormal(builder, normalOffset);
    _Fragment.addIndex(builder, indexOffset);
    _Fragment.addBlockId(builder, blockIdOffset);
    _Fragment.addGroups(builder, groupsOffset);
    _Fragment.addMaterials(builder, materialsOffset);
    _Fragment.addMatrices(builder, matricesOffset);
    _Fragment.addColors(builder, colorsOffset);
    _Fragment.addIds(builder, idsOffset);
    _Fragment.addId(builder, idOffset);
    _Fragment.addComposites(builder, compositesOffset);
    return _Fragment.endFragment(builder);
  }
};

// node_modules/bim-fragment/flatbuffers/fragments/index/fragments-group.js
var FragmentsGroup = class _FragmentsGroup {
  constructor() {
    this.bb = null;
    this.bb_pos = 0;
  }
  ...
  static getRootAsFragmentsGroup(bb, obj) {
    return (obj || new _FragmentsGroup()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
  }
  ...
  items(index, obj) {
    const offset = this.bb.__offset(this.bb_pos, 4);
    return offset ? (obj || new Fragment2()).__init(this.bb.__indirect(this.bb.__vector(this.bb_pos + offset) + index * 4), this.bb) : null;
  }
  itemsLength() {
    const offset = this.bb.__offset(this.bb_pos, 4);
    return offset ? this.bb.__vector_len(this.bb_pos + offset) : 0;
  ...
  static createFragmentsGroup(builder, itemsOffset, coordinationMatrixOffset, idsOffset, itemsKeysOffset, itemsKeysIndicesOffset, itemsRelsOffset, itemsRelsIndicesOffset, fragmentKeysOffset, idOffset, nameOffset, ifcNameOffset, ifcDescriptionOffset, ifcSchemaOffset, maxExpressId, boundingBoxOffset) {
    _FragmentsGroup.startFragmentsGroup(builder);
    _FragmentsGroup.addItems(builder, itemsOffset);
    _FragmentsGroup.addCoordinationMatrix(builder, coordinationMatrixOffset);
    _FragmentsGroup.addIds(builder, idsOffset);
    _FragmentsGroup.addItemsKeys(builder, itemsKeysOffset);
    _FragmentsGroup.addItemsKeysIndices(builder, itemsKeysIndicesOffset);
    _FragmentsGroup.addItemsRels(builder, itemsRelsOffset);
    _FragmentsGroup.addItemsRelsIndices(builder, itemsRelsIndicesOffset);
    _FragmentsGroup.addFragmentKeys(builder, fragmentKeysOffset);
    _FragmentsGroup.addId(builder, idOffset);
    _FragmentsGroup.addName(builder, nameOffset);
    _FragmentsGroup.addIfcName(builder, ifcNameOffset);
    _FragmentsGroup.addIfcDescription(builder, ifcDescriptionOffset);
    _FragmentsGroup.addIfcSchema(builder, ifcSchemaOffset);
    _FragmentsGroup.addMaxExpressId(builder, maxExpressId);
    _FragmentsGroup.addBoundingBox(builder, boundingBoxOffset);
    return _FragmentsGroup.endFragmentsGroup(builder);
  }
};

// node_modules/bim-fragment/fragments-group.js
var FragmentsGroup2 = class extends Group {
  constructor() {
    super(...arguments);
    this.items = [];
...
// node_modules/bim-fragment/serializer.js
var Serializer = class {
  ...
  import(bytes) {
    ...
    const fbFragmentsGroup = FragmentsGroup.getRootAsFragmentsGroup(buffer);
  ...
  export(group) {
    ...
    for (const fragment of group.items) {
      ...
      const blockVector = F.createBlockIdVector(builder, result2.blockID);
      ...
      const idsStr = builder.createString(result2.ids);
      ...
      const exported = Fragment2.endFragment(builder);
      items.push(exported);
    }
    ...
    const result = FragmentsGroup.endFragmentsGroup(builder);
  ...
  constructInstances(fragment) {
    ...
    if (isMergedFragment) {
      const transform = new Matrix4().fromArray(matricesData);
      const instances2 = [{ ids, transform }];
      return { instances: instances2, colors };
    }
    const instances = [];
    for (let i = 0; i < matricesData.length; i += 16) {
      ...
      const id2 = ids[i / 16];
      instances.push({ ids: [id2], transform });
    }
  ...
  constructFragmentGroup(group) {
    const fragmentsGroup = new FragmentsGroup2();
...
export {
  ...
  disposeBoundsTree,
  Fragment,
  FragmentsGroup2 as FragmentsGroup,
  Serializer
};
//# sourceMappingURL=chunk-T6I67UKM.js.map
